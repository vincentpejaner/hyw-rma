  ...
  return (
    <div className="site-container">
      ...
      <div className="content">
         <h1>Welcome to HYW RMA System</h1>
          <p>Manage your returns and warranty claims efficiently with our system.</p>
          <div className="hero-cta">
            <a href="#submit" className="btn primary">Submit RMA</a>
            <a href="#track" className="btn">Track RMA</a>
          </div>
        </div>
